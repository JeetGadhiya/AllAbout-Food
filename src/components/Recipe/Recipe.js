    ...
    <div className='main_container'>
      <div className='sub_container'>
        ...
        <div className='reciepe_container'>
          <div className='recipe'>
            <p className='recipe_name'>Dosa</p>
            <img src='https://www.cookwithmanali.com/wp-content/uploads/2020/05/Masala-Dosa.jpg' className='recipe_image drop-shadow-xl' />
            <p className='recipe_recipe'>
              Masala dosa is popular south Indian food across India.
              It is a thin and crispy pancake prepared with fermented dosa batter which is stuffed with potatoes masala and served with chutney and sambar.
            </p>
            <button className='recipe_button drop-shadow-xl items-center justify-center' onClick={() => setButtonPopup(true)}>
              Full Recipe
            </button>
            <Popup trigger={buttonPopup} setTrigger={setButtonPopup} ptime="20m" ctime="10m" ttime="30m" serve="4"
              ing="2 cup parboiled rice
>>>>>>> acad08f4703c5243e4949011c646f3725f66b566
              1/2 cup urad dal
              1 teaspoon salt
...
=======
          ...
          <div className='recipe'>
            <p className='recipe_name'>Utpam</p>
            <img src='https://www.idfreshfood.com/wp-content/uploads/2020/12/gbuoh.jpg' className='recipe_image drop-shadow-xl' />
            <p className='recipe_recipe'>
              Uttapam is a very popular South Indian breakfast dish.
              It is similar to dosa but slightly thicker than the regular dosas.
              It can be made with leftover idli dosa batter. Vegetable Uttapam can be served for breakfast or as a snack.
              Uttapam can be made with a variety of toppings like onion, tomato, coconut, and many others.
              Vegetable Uttapams are topped with finely chopped vegetables.
            </p>
            <button className='recipe_button drop-shadow-xl items-center justify-center' onClick={() => setButtonPopup(true)}>
              Full Recipe
            </button>
            <Popup trigger={buttonPopup} setTrigger={setButtonPopup} ptime="10m" ctime="10m" ttime="20m" serve="2"
              ing="1 cup Idli Dosa Batter , 1 cup idli dosa batter 
>>>>>>> acad08f4703c5243e4949011c646f3725f66b566
...
=======
          ...
          <div className='recipe'>
            <p className='recipe_name'>Medu Vada</p>
            <img src='https://www.secondrecipe.com/wp-content/uploads/2019/12/medu-wada.jpg' className='recipe_image drop-shadow-xl' />
            <p className='recipe_recipe'>
              The Medu Vada Recipe is a very traditional South Indian Tiffin/ Breakfast dish that is made from whole urad dal.
              Each home has a special recipe of how they spice up the Medu Vada batter.
            </p>
            <button className='recipe_button drop-shadow-xl items-center justify-center' >
              Full Recipe
            </button>
      ...
      <div className='sub_container'>
        ...
        <div className='reciepe_container'>
          <div className='recipe'>
            <p className='recipe_name'>Veg Kohlapuri</p>
            <img src='https://s3-ap-south-1.amazonaws.com/betterbutterbucket-silver/rekha-unni20180717103804653.jpeg' className='recipe_image drop-shadow-xl' />
            <p className='recipe_recipe'>
              ...
              It has really great layers of flavor. It has a combination of nutty, aromatic, spicy flavors.
            </p>
            <button className='recipe_button drop-shadow-xl items-center justify-center'>
              Full Recipe
            </button>
          ...
          <div className='recipe'>
            <p className='recipe_name'>Paneer Butter Masala</p>
            <img src='https://www.vegrecipesofindia.com/wp-content/uploads/2020/01/paneer-butter-masala-5.jpg' className='recipe_image drop-shadow-xl' />
            <p className='recipe_recipe'>
      ...
      <div className='sub_container'>
        ...
        <div className='reciepe_container'>
          <div className='recipe'>
            <p className='recipe_name'>White Sauce Pasta</p>
            <img src='https://www.whiskaffair.com/wp-content/uploads/2021/05/White-Sauce-Paste-2-3.jpg' className='recipe_image drop-shadow-xl' />
            <p className='recipe_recipe'>
              Penne Pasta In White Sauce Recipe is creamy, delicious and has healthy goodness of vegetables that is loaded into the pasta.
              Flavored with mixed dried Italian herbs, black pepper and dry red chilli flakes, this pasta dish is a treat to the taste buds and is ready within 30 minutes.
            </p>
            <button className='recipe_button drop-shadow-xl items-center justify-center' >
              Full Recipe
            </button>
          ...
          <div className='recipe'>
            <p className='recipe_name'>Tandoori Paneer Pizza</p>
            <img src='https://tempovalemount.com/wp-content/uploads/2021/07/paneer-pizza-1.jpg' className='recipe_image drop-shadow-xl' />
            <p className='recipe_recipe'>
              ...
              The paneer in the pizza makes it healthy and tasty.
              It pairs well with Indian Style Masala Macaroni for weekend night.
            </p>
            <button className='recipe_button drop-shadow-xl items-center justify-center' >
              Full Recipe
            </button>
      ...
      <div className='sub_container'>
        ...
        <div className='reciepe_container'>
          <div className='recipe'>
            <p className='recipe_name'>Belgian Chocolate Cranberry Cake</p>
            <img src='http://cdn.shopify.com/s/files/1/0065/0045/0351/products/dark-chocolate-truffle_8442ada7-e682-493a-8226-4e1cfefc2925_1200x1200.jpg?v=1613118672' className='recipe_image drop-shadow-xl' />
            <p className='recipe_recipe'>
              This chocolate layer cake filled with cranberry and port compote is absolutely irresistible.
              Rich chocolate cake layers gently wrapped in whipped chocolate ganache, then decorated with sparkling cranberries.
            </p>
            <button className='recipe_button drop-shadow-xl items-center justify-center' >
              Full Recipe
            </button>
          ...
          <div className='recipe'>
            <p className='recipe_name'>Classic Chocolate Mouse</p>
            <img src='https://realfood.tesco.com/media/images/RFO-1400x919-classic-chocolate-mousse-69ef9c9c-5bfb-4750-80e1-31aafbd80821-0-1400x919.jpg' className='recipe_image drop-shadow-xl' />
            <p className='recipe_recipe'>
              Creamy chocolate mousse is an absolute classic, and this indulgent gluten-free dessert recipe is so easy to follow.
              Whip up the mousse with rich dark chocolate and allow to set overnight, before serving with whipped cream and chocolate shards, if you like.
              Stunning dinner party desserts don't get better than this!
            </p>
            <button className='recipe_button drop-shadow-xl items-center justify-center' >
              Full Recipe
            </button>
